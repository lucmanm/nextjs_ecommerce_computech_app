...
const Product = () => {
  return (
    <div className="dt:p-3 my-1 flex w-60 flex-col gap-3 overflow-hidden rounded-lg bg-white p-2 shadow-sm">
      ...
      <div className="flex">
        <div className="flex">
          <span className="tb:p-0.5 tb:text-lg inline-block self-end pb-1 pr-1 text-sm font-medium">
            SR
          </span>
        ...
        <span className="tb:p-0.5 tb:text-lg inline-block self-end pb-1 pl-1 text-sm font-medium text-red-500 line-through">
          SR 0,000
        </span>
      </div>
      <div className="">
